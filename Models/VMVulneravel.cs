...
{
    public class InitialRegisterVulneravel
    {
        [Required]
    ...
    public class FinalRegisterVulneravel
    {
    ...
    public class ConfirmaVulneravel
    {
        public int codigo { get; set; }

        public string CpfVulneravel { get; set; }

        public string RgVulneravel { get; set; }
