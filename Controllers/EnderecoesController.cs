...
namespace Dory2.Controllers
{
    public class EnderecoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Logradouro,Numero,Bairro,Cidade,Estado")] Endereco endereco)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Logradouro,Numero,Bairro,Cidade,Estado")] Endereco endereco)
        {
            if (ModelState.IsValid)
            {
